package com.example.alomproject3.photoedit;
...
import com.example.alomproject3.photoedit.base.BaseActivity;
import com.example.alomproject3.photoedit.filters.FilterListener;
import com.example.alomproject3.photoedit.filters.FilterViewAdapter;
import com.example.alomproject3.photoedit.tools.EditingToolsAdapter;
import com.example.alomproject3.photoedit.tools.ToolType;
import com.example.alomproject3.R;
...
import static com.example.alomproject3.photoedit.FileSaveHelper.isSdkHigherThan28;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tag = editIntent.getStringExtra("TAG");
        Uri intentUri = Uri.parse(editIntent.getStringExtra("imageUri"));
        ...
        try {
            ...
            Bitmap intentBitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), intentUri);
            mPhotoEditorView.getSource().setImageBitmap(intentBitmap);
        } catch (IOException e) {
            e.printStackTrace();
        }
